...
var normalizeHeaders = /* @__PURE__ */ __name((headers) => {
  ...
  for (const [key, value] of Object.entries(headers)) {
    if (key && typeof key === "string" && value !== void 0) {
...
var CustomResponse = class extends Response {
  static {
...
setDefaultStrategy((0, import_util2.shouldUseGlobalFetchAndWebSocket)() ? fetch : customFetch);
